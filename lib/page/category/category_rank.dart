...
import 'package:reader/page/category/category_kind.dart';
        ...
        children: <Widget>[
          ...
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: [
                CategoryKindPage(widget.categoryId, "hot"),
                CategoryKindPage(widget.categoryId, "new"),
                CategoryKindPage(widget.categoryId, "vote"),
                CategoryKindPage(widget.categoryId, "over"),
              ],
            ),
          ),
        ],
