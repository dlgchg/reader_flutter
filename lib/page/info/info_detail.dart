...
import 'package:reader/page/info/comment.dart';
import 'package:reader/page/read/catalog.dart';
import 'package:reader/page/read/read.dart';
import 'package:reader/page/info/same_category.dart';
import 'package:reader/page/info/same_author.dart';
...
class InfoDetailPage extends StatefulWidget {
  ...
  InfoDetailPage(this.bookName, this.bookId);
}

class _BookInfoState extends State<InfoDetailPage>
      ...
      child: GestureDetector(
        onTap: () {
          setState(() {
            Navigator.push(context,
                MaterialPageRoute(builder: (BuildContext context) {
              return SameAuthorPage(_bookInfo.SameUserBooks);
            }));
          });
        },
        child: Container(
      ...
      child: GestureDetector(
        onTap: () {
          setState(() {
            Navigator.push(context,
                MaterialPageRoute(builder: (BuildContext context) {
              return SameCategoryPage(_bookInfo.SameCategoryBooks);
            }));
          });
        },
        child: Container(
